...
void In_Hoa_Chu_Cai_Dau_Trong_Chuoi(string chuoi) {
    ...
    {
        chuoi[0] = chuoi[0] - 32;
        for (size_t i = 1; i < chuoi.length(); i++)
        {
            if (chuoi[i] == ' ' && chuoi[i+1] != ' ')
            {
                chuoi[i+1] = chuoi[i+1] - 32;
...
void In_Thuong_Cac_Ky_Tu_Trong_Chuoi(string chuoi) {
    if (chuoi[0] == ' ')
    {
        for (size_t i = 0; i < chuoi.length(); i++)
        {
...
int main()
{
    ...
    string chuoi;
    getline(cin, chuoi);
    //In_Hoa_Chu_Cai_Dau_Trong_Chuoi(chuoi);
    In_Thuong_Cac_Ky_Tu_Trong_Chuoi(chuoi);
    system("Pause");
}